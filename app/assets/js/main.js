...
buf.push("" + (jade.escape((jade_interp =  log ) == null ? '' : jade_interp)) + "总结");
jade_debug.shift();
jade_debug.shift();
buf.push("</li>");
jade_debug.shift();
