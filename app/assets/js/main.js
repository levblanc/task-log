...
buf.push("\n  <textarea placeholder=\"请输入工作内容\" rows=\"1\" autofocus=\"autofocus\" class=\"logInput\">");
jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
jade_debug.shift();
buf.push("</textarea>");
jade_debug.shift();
